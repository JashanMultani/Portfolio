...
class Social extends React.Component {
  render() {
    ...
    return (
      <SocialBar>
        <a
          href="https://github.com/JashanMultani"
        ...
        <a
          href="https://www.linkedin.com/in/jashanpreet-singh-9235351aa/"
          rel="noopener noreferrer"
          target="_blank"
        >
        ...
        <a
          href="https://twitter.com/Jashanp62705761 "
          rel="noopener noreferrer"
          target="_blank"
        >
        ...
        <a
          href="https://stackoverflow.com/users/14428706/jashanpreet-singh"
          rel="noopener noreferrer"
          target="_blank"
        >
